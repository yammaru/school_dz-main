...
class Webinar extends Model implements TranslatableContract
{
    ...
    static $classroomCourse = 'classroom_course';
    ...
    public function studyPlanChapters()
    {
        return $this->hasMany('App\Models\StudyPlanChapter', 'webinar_id', 'id');
    }
    ...
    {
        return ($this->type == 'classroom_course');
    }
