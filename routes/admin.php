...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => 'web'], function () {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'enrollments'], function () {
            Route::get('/', 'EnrollmentController@interested');
            Route::get('/{id}/edit', 'EnrollmentController@interestedEdit');
            Route::get('/{id}/delete', 'EnrollmentController@interestedDestroy');
            Route::post('/{id}/update-note', 'EnrollmentController@updateNote');
        ...
        Route::group(['prefix' => 'study_plan_text_lesson'], function () {
            Route::post('/store', 'StudyPlanTextLessonController@store');
            Route::post('/{id}/edit', 'StudyPlanTextLessonController@edit');
            Route::post('/{id}/update', 'StudyPlanTextLessonController@update');
            Route::get('/{id}/delete', 'StudyPlanTextLessonController@destroy');
        });

        Route::group(['prefix' => 'study_plan_chapters'], function () {
            Route::get('/{id}', 'ChapterController@getChapter');
            Route::get('/getAllByWebinarId/{webinar_id}', 'ChapterController@getAllByWebinarId');
            Route::post('/store', 'StudyPlanChapterController@store');
            Route::post('/{id}/edit', 'StudyPlanChapterController@edit');
            Route::post('/{id}/update', 'StudyPlanChapterController@update');
