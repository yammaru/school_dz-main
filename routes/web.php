...
Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance']], function () {
   ...
   /* Route::group(['prefix' => 'attendances'], function () {
        Route::group(['middleware' => 'user.not.access'], function () {
            Route::post('/confirmAssistance', 'AttendanceController@confirmAssistance');
            Route::get('/', 'AttendanceController@index');
            Route::get('/new', 'AttendanceController@create');
            Route::get('/{id}/search', 'AttendanceController@search');
            Route::post('/store', 'AttendanceController@store');
            Route::get('/{id}/edit', 'AttendanceController@edit')->name('panel_edit_webinar');
            Route::post('/{id}/update', 'AttendanceController@update');
            Route::get('/{id}/delete', 'AttendanceController@destroy');
    ...
    Route::group(['prefix' => 'attendances'], function () {
        Route::group(['middleware' => 'user.not.access'], function () {
            ...
            Route::get('/{id}/search', 'AttendanceController@search');
            Route::post('/store', 'AttendanceController@store');
            Route::get('/{id}/step/{step?}', 'AttendanceController@edit');
            Route::get('/{id}/edit', 'AttendanceController@edit')->name('panel_edit_webinar');
            Route::post('/{id}/update', 'AttendanceController@update');
            Route::get('/{id}/delete', 'AttendanceController@destroy');
    ...
    Route::group(['prefix' => 'attendance_translations'], function () {
        Route::get('/{id}/search', 'AttendanceTranslationsController@search');
    });
    Route::group(['prefix' => 'register_classroom_course'], function () {
       Route::get('/', 'RegisterClassroomCourseController@index');
       Route::get('/new', 'RegisterClassroomCourseController@create');
       Route::post('/store', 'RegisterClassroomCourseController@store');
       Route::get('/{id}/search', 'RegisterClassroomCourseController@search');
    });
