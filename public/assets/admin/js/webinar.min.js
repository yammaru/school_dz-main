...
(function ($) {
  ...
  $('body').on('click', '.js-add-study_plan_chapter', function (e) {
    ...
    Swal.fire({
      ...
      width: '36rem',
      onOpen: function onOpen() {
        var modal = $('#studyPlanChapterModal' + random);
        ...
        if (itemId) {
          ...
          var path = adminPanelPrefix + '/study_plan_chapters/' + itemId + '/update';
  ...
  $('body').on('click', '.js-add-course-content-btn, .add-new-interactive-file-btn', function (e) {
    ...
    switch (type) {
      ...
      case 'study_plan':
        var newStudyPlanTextLessonForm = $('#newStudyPlanTextLessonForm');
  ...
  $('body').on('click', '.js-add-study-plan-content-btn', function (e) {
    ...
    var type = $this.attr('data-type');
    var chapterId = $this.attr('data-chapter');
    var contentTagId = '#studyChapterContentAccordion' + chapterId;
    var key = randomString();
    var html = '';
    var newStudyPlanTextLessonForm = $('#newStudyPlanTextLessonForm');
    newStudyPlanTextLessonForm.find('.chapter-input').val(chapterId);
  ...
  $('body').on('click', '.js-change-study-content-chapter', function (e) {
    ...
    Swal.fire({
      ...
      width: '36rem',
      onOpen: function onOpen() {
        var modal = $('#changeStudyPlanChapterModalHtml' + random);
        modal.find('input.js-item-id').val(itemId);
        /*modal.find('input.js-item-type').val(itemType);*/
  ...
  $('body').on('click', '.save-change-study-plan-chapter', function (e) {
    e.preventDefault();
    var $this = $(this);
    var form = $this.closest('.study-change-chapter-form');
  ...
  * */
  ...
  $('body').on('click', '.save-study-plan-chapter', function (e) {
    e.preventDefault();
    var $this = $(this);
    var form = $this.closest('.study-chapter-form');
    handleStudyPlanChapterForm(form, $this);
  });
})(jQuery);
