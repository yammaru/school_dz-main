                ...
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/webinars*', false)) and !request()->is(getAdminPanelUrl('/webinars/comments*', false))) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_webinars_list')
                            ...
                            <li class="{{ (request()->is(getAdminPanelUrl('/webinars', false)) and request()->get('type') == 'classroom_course') ? 'active' : '' }}  ">
                                <a class="nav-link @if(!empty($sidebarBeeps['classroomCourse']) and $sidebarBeeps['classroomCourse']) beep beep-sidebar @endif"
                                   href="{{ getAdminPanelUrl() }}/webinars?type=classroom_course">{{ trans('admin/main.classroom_course') }}</a>
                            </li>
                ...
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/enrollments*', false))) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @endcan
                            @can('admin_enrollment_history')
                                <li class="">
                                    <a class="nav-link" href="{{ getAdminPanelUrl() }}/enrollments/"  >{{ trans('admin/main.interested_courses') }}</a>
                                </li>
                            @endcan
