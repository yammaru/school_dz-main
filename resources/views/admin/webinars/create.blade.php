                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ getAdminPanelUrl() }}/webinars/{{ !empty($webinar) ? $webinar->id.'/update' : 'store' }}" id="webinarForm" class="webinar-form">
                                        ...
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15 ">
                                                ...
                                                <select name="type" class="custom-select @error('type')  is-invalid @enderror" >
                                                    ...
                                                    <option value="classroom_course" @if((!empty($webinar) and $webinar->isClassroomCourse()) or old('type') == \App\Models\Webinar::$classroomCourse) selected @endif>{{ trans('product.classroom_course') }}</option>
                                                    <option value="text_lesson">{{ trans('product.text_course') }} (Paid plugin)</option>
                                                </select>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="number" name="points" value="{{ !empty($webinar) ? $webinar->points : old('points') }}" class="form-control @error('points')  is-invalid @enderror" placeholder={{ trans('admin/main.empty_points') }}/>
                                                @error('points')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            @if(!empty($webinar) and $webinar->creator->isOrganization())
                                                <div class="form-group mt-15 ">
                                                    ...
                                                    <select name="organ_id" data-search-option="just_organization_role" class="form-control search-user-select2" data-placeholder="{{ trans('admin/main.search_organization') }}">
                                ...
                                @if(!empty($webinar))
                                    ...
                                    {{--New Study plan--}}
                                    @include('admin.webinars.create_includes.study_plan')
                            ...
                            @include('admin.webinars.modals.study_plan_text_lesson')
...
@push('scripts_bottom')
    ...
    {{--<script src="/assets/admin/js/webinar_study.js"></script>--}}
