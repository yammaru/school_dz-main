                            ...
                            <tr>
                                ...
                                <td class="" width="50">
                                    @can('admin_reviews_status_toggle')
                                        <a href="{{ getAdminPanelUrl() }}/reviews/{{ $review->id }}/toggleStatus" class="btn-transparent text-primary mr-1" data-toggle="tooltip" data-placement="top" title="{{ ($review->status == 'active') ? 'Oculto' : 'Publicar' }}">
                                            @if($review->status == 'active')
                                    ...
                                    @can('admin_reviews_detail_show')
                                        ...
                                        <button type="button" class="js-show-review-details btn-transparent text-primary mr-1" data-toggle="tooltip" data-placement="top" title="Detalle de tarifa">
