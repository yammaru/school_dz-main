                            ...
                            <table class="table table-striped font-14">
                                ...
                                @foreach($getTopSellingTeachers as $getTopSellingTeacher)
                                    <tr>
                                        ...
                                        <td>{{ convertMinutesToHourAndMinute($getTopSellingTeacher->classes_durations) }} Horas</td>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                @foreach($getTopSellingOrganizations as $getTopSellingOrganization)
                                    <tr>
                                        ...
                                        <td>{{ convertMinutesToHourAndMinute($getTopSellingOrganization->classes_durations) }} Horas</td>
