                ...
                <div class="course-content-body user-select-none">
                    ...
                    <div class="mt-35">
                        <ul class="nav nav-tabs bg-secondary rounded-sm p-15 d-flex align-items-center justify-content-between" id="tabs-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="position-relative font-14 text-white {{ (request()->get('tab','') == 'study_plan') ? 'active' : '' }}" id="content-tab" data-toggle="tab"
                                   href="#study_plan" role="tab" aria-controls="study_plan"
                                   aria-selected="false">{{ trans('product.study_plan') }} ({{ $webinarStudyPlanCount }})</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade {{ (request()->get('tab','') == 'study_plan') ? 'show active' : '' }}" id="study_plan" role="tabpanel" aria-labelledby="content-tab">
                                @include(getTemplate().'.course.tabs.study_plan')
                            </div>
            ...
            <div class="course-content-sidebar col-12 col-lg-4 mt-25 mt-lg-0">
                <div class="rounded-lg shadow-sm">
                    ...
                    <div class="px-20 pb-30">
                        {{--@if($course->type==='classroom_course')
                            <div class="d-flex align-items-center justify-content-center mt-30 " >
                                <a href="/register_classroom_course/{{ $course->id }}/search" >
                            ...
                            <form action="/cart/store" method="post">
                                ...
                                <div class="mt-20 d-flex flex-column">
                                    ...
                                    @elseif($course->price > 0)
                                        ...
                                        @else
                                            <a href="/register_classroom_course/{{ $course->id }}/search" class="btn btn-primary " >
                                                {{ trans('public.interested') }}
                                            </a>
                                        @endif
                            ...
                            @if($course->isWebinar())
                                <div class="col">
                                    <a href="{{ $course->addToCalendarLink() }}" target="_blank" class="d-flex flex-column align-items-center text-center text-gray">
                                        ...
                                        <span class="font-12">{{ trans('webinars.downloadable_content') }}</span>
                                    </a>
                                </div>
                            @endif
