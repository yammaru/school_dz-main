    ...
    <section class="dashboard">
        <div class="row">
            ...
            <div class="col-12 col-lg-3 mt-35">
                ...
                <?php if($authUser->isUser()): ?>
                    <a  class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 d-flex align-items-center mt-15 mt-md-30">
                        <div class="stat-icon support-messages">
                            <img src="<?php if($authUser->isUser()): ?> /assets/default/img/icons/meeting.svg <?php else: ?> /assets/default/img/icons/monay.svg <?php endif; ?>" alt="">
                        </div>
                        <div class="d-flex flex-column ml-15">
                            <span class="font-30 text-secondary"><?php echo e($attendancesCount); ?></span>
                            <span class="font-16 text-gray font-weight-500"><?php echo e(trans('admin/main.attendances')); ?></span>
                        </div>
                    </a>
                <?php endif; ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\school-dz\resources\views/web/default/panel/dashboard/index.blade.php ENDPATH**/ ?>