...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php echo e(trans('admin/main.list_'.$classesType.'s')); ?> </h1>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="teacher_ids[]" multiple="multiple" data-search-option="just_teacher_role" class="form-control search-user-select2"
                                            data-placeholder=<?php echo e(trans('admin/main.search_teachers')); ?>>
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        ...
                        <div >
                            <div class="card-body table-responsive min-height-table"  >
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\school_dz-main\resources\views/admin/webinars/lists.blade.php ENDPATH**/ ?>