            ...
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        ...
                        <h1 class="text-white font-30 mb-15"><?php echo e(trans('product.courses')); ?></h1>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="mt-20 p-20 rounded-sm shadow-lg border border-gray300 filters-container">
                            ...
                            <div class="">
                                ...
                                <div class="pt-10">
                                    <?php $__currentLoopData = ['bundle','webinar','course','text_lesson','classroom_course']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\school_dz-main\resources\views/web/default/pages/classes.blade.php ENDPATH**/ ?>