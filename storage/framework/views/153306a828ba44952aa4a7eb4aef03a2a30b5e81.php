        ...
        <div class="custom-dropdown-body pb-10">
            ...
            <div class="dropdown-user-avatar d-flex align-items-center p-15 m-15 mb-10 rounded-sm border">
                ...
                <div class="ml-5">
                    ...
                    <span class="mt-5 text-gray font-12"><?php echo e(trans('panel.role_'.$authUser->role->name)); ?></span>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\school_dz-main\resources\views/web/default/includes/top_nav/user_menu.blade.php ENDPATH**/ ?>