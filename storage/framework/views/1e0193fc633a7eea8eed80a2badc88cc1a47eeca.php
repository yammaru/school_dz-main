...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1>aaaaaaaaaaaaaa<?php echo e(!empty($webinar) ?trans('/admin/main.edit'): trans('admin/main.new')); ?> <?php echo e(trans('admin/main.class')); ?></h1>
...
unset($__errorArgs, $__bag); ?>" >
                                                    ...
                                                    <option value="classroom_course" <?php if((!empty($webinar) and $webinar->isClassroomCourse()) or old('type') == \App\Models\Webinar::$classroomCourse): ?> selected <?php endif; ?>><?php echo e(trans('product.classroom_course')); ?></option>
                                                    <option value="text_lesson"><?php echo e(trans('product.text_course')); ?> (Paid plugin)</option>
                                                </select>
...
unset($__errorArgs, $__bag); ?>" placeholder=<?php echo e(trans('admin/main.empty_points')); ?>/>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php if(!empty($webinar) and $webinar->creator->isOrganization()): ?>
                                                <div class="form-group mt-15 ">
                                                    ...
                                                    <select name="organ_id" data-search-option="just_organization_role" class="form-control search-user-select2" data-placeholder="<?php echo e(trans('admin/main.search_organization')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if(!empty($webinar)): ?>
                                    ...
                                    <?php echo $__env->make('admin.webinars.create_includes.study_plan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <?php echo $__env->make('admin.webinars.modals.study_plan_text_lesson', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\school_dz-main\resources\views/admin/webinars/create.blade.php ENDPATH**/ ?>