<div class="tab-pane mt-3 fade" id="registrationPackage" role="tabpanel" aria-labelledby="registrationPackage-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="<?php echo e(getAdminPanelUrl()); ?>/users/groups/<?php echo e($group->id); ?>/groupRegistrationPackage" method="Post">
...
<?php /**PATH C:\laragon\www\school_dz-main\resources\views/admin/users/groups/tabs/registration_package.blade.php ENDPATH**/ ?>